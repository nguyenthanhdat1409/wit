...
${data.content}`;
    ...
    function createVocabularyFile(vocabularyData, markdownContent) {
        return new Promise((resolve, reject) => {
            ...
            const apiEndpoint = getApiEndpoint('/create-vocabulary');
    ...
    // Helper function to detect API endpoint based on environment
    function getApiEndpoint(path) {
        const hostname = window.location.hostname;
        
        if (hostname.includes('netlify.app') || hostname.includes('happymarketdocs.com')) {
            // Production/Deploy Preview: Use Netlify Functions
