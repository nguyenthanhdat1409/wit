...
function hideWordPressHeader(iframe) {
    try {
        ...
        // Inject CSS để ẩn header WordPress
        ...
        style.textContent = `
            ...
            /* Điều chỉnh body để bỏ margin/padding top */
            body {
                margin-top: 0 !important;
                padding-top: 0 !important;
            }
            
            /* Ẩn các element có thể là header */
            .site-header,
            .header,
            .main-header,
            .page-header,
